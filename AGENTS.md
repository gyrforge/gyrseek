...
- Test strategy:
  ...
  - src/lib.rs (inline) — GyrSeek::parse_package_details for all supported managers and subcommands; config parsing for new_package_exemptions and internal_package_exemptions
