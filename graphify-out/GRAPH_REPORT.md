...
## Corpus Check
- 23 files · ~42,352 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 571 nodes · 1224 edges · 27 communities (20 shown, 7 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 34 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `347cd84b`
...
Cohesion: 0.05
Nodes (40): Architecture, Core Components, Current Limitations, Decision Model, Empty-Trace Hard Error, Fail-Closed Policy, Goal, Internal Package Exemption (+32 more)
...
## Knowledge Gaps
- **129 isolated node(s):** `$schema`, `plugin`, `BaselineOverrideConfig`, `Drop`, `ForwardMode` (+124 more)
...
- **Why does `trace_sandbox_install_matrix()` connect `Git-Clone & Process-Exec Signatures` to `Sandbox Backends & Docker/strace`, `Connection IP Extraction & Filtering`, `Bun Execution Detection & Exemptions`, `Registry History & Baseline Selection`, `Domain Allowlist & DNS Enrichment`, `Fail-Closed Forwarding Tests`?**
