# Graph Report - gyrseek  (2026-07-04)

## Corpus Check
- 103 files · ~194,042 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1957 nodes · 2900 edges · 153 communities (109 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 39 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0de664a5`
...
1. `Review history` - 166 edges
2. `Won't Fix Findings - Detailed` - 118 edges
3. `Detailed Findings` - 103 edges
...
Cohesion: 0.06
Nodes (69): Box, Empty-Trace Hard Error, CAP_SYS_PTRACE for Cross-UID Tracing, Unprivileged-Payload Trace Integrity (strace -u), Finding 1: Empty Trace Passes As Clean, Finding 4: || true Suppresses strace Failures, MicroVM Sandbox Backend (planned hardening), announce_apparmor_status() (+61 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (60): Finding 10: Self-Referencing Baseline Override (Open), G, artifact_delimiter_pipe_in_path_is_not_injected(), baseline_count_limits_fetched_baselines_without_overrides(), baseline_count_zero_does_not_fail_closed(), baseline_count_zero_returns_no_effective_baselines(), baseline_count_zero_with_override_equal_to_current_returns_empty(), both_override_slots_none_falls_through_to_fetched_baselines() (+52 more)
...
Cohesion: 0.11
Nodes (37): Behavioral Diffing, active_test_env_vars(), active_test_env_vars_none_set_returns_empty(), active_test_env_vars_set_var_is_detected(), allows_new_bun_when_allowlisted(), allows_when_artifact_findings_match_baseline(), allows_when_bun_behavior_matches_baseline(), artifact_allowlist_unblocks_new_findings() (+29 more)
...
Cohesion: 0.14
Nodes (14): 1. AI Reviewer Sandbox and Prompt Injection, 2. Sandbox Syscall Permissiveness, 3. CI/CD Architecture Trade-offs, 4. DNS Exfiltration Boundaries, Architecture, CI/CD Pipeline Architecture, Core Components, Current Limitations (+6 more)
...
Cohesion: 0.22
Nodes (16): Default, In-Run Scan Cache, PolicyConfig, ScanReport, NoopRunner, Drop, SandboxRunner, Self (+8 more)
...
Cohesion: 0.12
Nodes (17): IpAddr, dns_interceptor_end_to_end_with_realistic_strace_trace(), extract_dns_map(), extract_dns_map_connect_failure_ignored(), extract_dns_map_empty_trace(), extract_dns_map_ipv6_tcp_dns_response(), extract_dns_map_ipv6_udp_dns_response(), extract_dns_map_malformed_payload_skipped() (+9 more)

### Community 130 - "Community 130"
Cohesion: 0.20
Nodes (10): extract_sensitive_file_reads(), is_sensitive_file_read(), lexical_clean_path(), test_appsec_evasion_bypasses(), test_appsec_evasion_exhaustive_variants(), test_extract_sensitive_file_reads(), test_extract_sensitive_file_reads_at_fdcwd_and_minus_100(), test_extract_sensitive_file_reads_edge_cases() (+2 more)
...
## Knowledge Gaps
- **1018 isolated node(s):** `check_diff.sh script`, `consolidate_reviews.sh script`, `generate_review.sh script`, `post_comment.sh script`, `test_check_diff.sh script` (+1013 more)
...
- **Why does `run()` connect `Community 149` to `Community 0`, `Community 1`, `Community 2`, `Community 132`, `Community 4`, `Community 151`, `Community 123`, `Community 124`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Developer Guide` connect `Community 110` to `Community 122`, `Community 132`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `scan_packages_versions()` connect `Community 5` to `Community 3`, `Community 7`, `Community 9`, `Community 10`, `Community 28`, `Community 110`, `Community 120`, `Community 121`, `Community 124`?**
