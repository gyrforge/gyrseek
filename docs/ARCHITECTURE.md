...
- **Sanitization**: Before posting any AI-generated output to the PR, the trusted phase passes the markdown through `cmark --safe`, which strictly omits raw HTML tags and dangerous URLs (e.g., `javascript:` URIs) to neutralize any XSS payloads hallucinated or injected by the AI.
